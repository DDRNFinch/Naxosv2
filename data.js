const STORAGE_KEY = 'naxosv2-course-st0095-v1';
...
const defaultState = {
  ...
  version: '1.2',
  packs: [
    { id: 'pack-1', name: 'Safe Working, Planning & Preparation', s: ['S1','S2','S3','S4','S5','S6','S7'], k: ['K1','K2','K3','K4','K5','K7','K8','K10','K11','K12'], b: ['B1','B2'] },
    { id: 'pack-2', name: 'Tools, Materials & Mortar', s: ['S8','S9','S14','S15','S17'], k: ['K13','K14','K20','K25','K29'], b: ['B1','B2'] },
    { id: 'pack-3', name: 'Cavity Wall Construction', s: ['S10','S11','S12'], k: ['K6','K8','K9','K17','K19','K21','K22','K23'], b: ['B3'] },
    { id: 'pack-4', name: 'Solid Walling, Features & Repairs', s: ['S13','S16','S22'], k: ['K15','K16','K18','K24','K30'], b: ['B3'] },
    { id: 'pack-5', name: 'Working With Others & Professional Practice', s: ['S18','S19','S20','S21'], k: ['K26','K27','K28','K31'], b: ['B4','B5','B6'] }
  ]
};
